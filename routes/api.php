...
Route::get('/reservations/{hotel_id}', function($hotel_id) {
    
    $data = Reservation::where('hotel_id', $hotel_id)->get();
    $room = Room::where('hotel_id', $hotel_id)->get();
    return response()->json(new JsonResponse(['items' =>$data, 'rooms' => $room]));
});

// Route::get('/room/{hotel_id}', function($hotel_id) {    
//     $data = Room::where('hotel_id', $hotel_id)->get();
//     return response()->json(new JsonResponse(['items' =>$data]));
